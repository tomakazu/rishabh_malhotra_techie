const experiences = [
    {
        company: "Current Fintech Company",
        ...
        achievements: [
        "Developed dynamic KFS (Key Fact Statement) generation workflows by populating DOCX templates with borrower information, loan details, EMI schedules, and regulatory disclosures.",

        "Integrated banking and credit bureau APIs for borrower onboarding, credit assessment, and financial data retrieval.",

        "Built borrower eligibility and risk assessment workflows to support lending and underwriting processes.",

        "Optimized database performance by identifying and eliminating N+1 queries and inefficient data access patterns.",

        "Refactored legacy modules to improve maintainability, scalability, and code quality.",

        "Contributed to performance and reliability improvements across critical lending workflows.",
        ],
    },
